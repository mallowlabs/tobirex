...
# from lexical definition file "C:\Documents and Settings\Owner\My Documents\ruby_files\tobirex\lib\tobirex\plugin\javascript.rex".
#
  ...
  def scan_evaluate( str )
    ...
    until ss.eos?
      ...
      when nil
        ...
        when (text = ss.scan(/[\{\}]/))
           @rex_tokens.push action { [:brace, text, lineno, update(text)] }

        when (text = ss.scan(/;/))
           @rex_tokens.push action { [:semi, text, lineno, update(text)] }
