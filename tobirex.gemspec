Gem::Specification.new do |s|
  ...
  s.files = ["README", "bin/tobirex", "tobirex.gemspec", "lib/tobirex.rb", "lib/tobirex/parser.rb", "lib/tobirex/plugin/javascript.rex", "lib/tobirex/plugin/javascript.rex.rb",  "test/test_tobirex.rb",  "test/test.js"]
  s.has_rdoc = false
