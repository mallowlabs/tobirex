Gem::Specification.new do |s|
  ...
  s.files = ["README", "bin/tobirex", "lib/tobirex.rb", "lib/tobirex/parser.rb", "lib/tobirex/plugin/javascript.rex", "lib/tobirex/plugin/javascript.rex.rb",  "test/test_tobirex.rb",  "sample/colorize.js"]
  s.has_rdoc = true
